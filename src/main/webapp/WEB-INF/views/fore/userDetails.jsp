    ...
    <div class="header">
        <div id="mallLogo">
            <a href="${pageContext.request.contextPath}/">
                <img src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/logo.png"/>
                <span class="span_tmallRegister" style="margin-top: 32px;">User Center</span>
            </a>
        </div>
    </div>
</nav>
    ...
    <div class="sns-config" id="profile">
        ...
        <div class="sns-main">
            <div id="tips-box">
                ...
                <label class="font_we">Filling in real information will help your friends find you.</label>
            </div>
            <form action="${pageContext.request.contextPath}/user/update" method="post" id="register_form">
                ...
                <div class="form-item">
                    <label class="form-label tsl">Realname：</label>
                ...
                <div class="form-item">
                    ...
                    <input name="user_password" type="password" id="user_password" class="form-text err-input"
                           placeholder="Please set a login password" maxlength="20">
                    <span class="form_span"></span>
                </div>
                <div class="form-item">
                ...
                <div class="form-item last-item">
                    <label class="form-label tsl">Current Address：</label>
